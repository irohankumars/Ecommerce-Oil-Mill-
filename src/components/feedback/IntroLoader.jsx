...
// ─────────────────────────────────────────────
// Easing curves — only premium, no bounce/elastic
// ─────────────────────────────────────────────
...
// ─────────────────────────────────────────────
// LoaderAnimation — the cinematic screen
...
// ─────────────────────────────────────────────
// IntroLoader — gatekeeper
//
// • While loading === true  → render ONLY <LoaderAnimation>
//   Children are NOT mounted, NOT in the DOM.
// • After loading === false → render children only.
...
export default function IntroLoader({ children }) {
  ...
  //   "skip"    — sessionStorage key already set; skip immediately to children
  //   "playing" — intro is running
  //   "exiting" — exit animation in progress (children still blocked)
  //   "done"    — hand off to children
  const [phase, setPhase] = useState(() => {
    // Initialiser runs synchronously before first paint —
  ...
  useEffect(() => {
    // Already skipped — nothing to schedule.
