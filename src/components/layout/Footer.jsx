      ...
      <Container className="py-12 md:py-16 xl:py-20">
        <div className="text-center">
          ...
          >
            ...
            <span className="mt-3 font-serif text-6xl font-semibold leading-none text-ink sm:text-7xl lg:text-8xl">
              Velora
            </span>
          </Link>
          <a
            href="https://www.glora.studio"
            target="_blank"
          ...
          >
            <span className="text-[10px] font-bold uppercase tracking-[0.22em] text-ink/38">
              Made by team
            </span>
            <img
              src="/glora-black.svg"
                ...
                <div className="mt-5 grid gap-3">
                  {column.links.map((link) => (
                    <Link
                      key={link.label}
                      to={link.href}
                      className="font-semibold text-ink/62 transition duration-200 hover:translate-x-1 hover:text-leaf"
                    >
                      {link.label}
                    </Link>
                  ))}
          ...
          <div className="grid gap-4">
            <div className="rounded-[2rem] bg-ink p-6 text-white shadow-soft sm:p-8">
              ...
              >
                ...
                <button
                  type="submit"
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-white px-6 text-sm font-semibold text-ink transition duration-300 hover:bg-linen"
                >
            ...
            <div className="grid gap-4 rounded-[2rem] bg-white p-6 shadow-sm sm:p-8">
              <div className="grid gap-3 text-sm font-semibold text-ink/62">
                <span className="flex items-center gap-3">
                  <MapPin size={18} className="text-leaf" /> Indiranagar,
                  Bengaluru
                </span>
                <span className="flex items-center gap-3">
                  <Phone size={18} className="text-leaf" /> +91 98765 43210
                </span>
                <span className="flex items-center gap-3">
                  <Mail size={18} className="text-leaf" /> care@veloraoils.in
                </span>
              </div>
